# assessments/ — 稽核、研究、選型 spike

一次性的技術稽核、競品分析與選型調查。帶時間戳快照,**不隨 code 更新**;結論過時則歸檔至 `../archive/`(不刪除)。
...
> 慣例上稽核類檔名可帶日期(如 `spike-native-plugin-2026-06-15.md`);此處日期暫記於索引,避免動到既有交叉引用。需要正名再一併改連結。
